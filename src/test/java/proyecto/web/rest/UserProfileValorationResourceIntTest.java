...
public class UserProfileValorationResourceIntTest {
    ...
    public void setup() {
        MockitoAnnotations.initMocks(this);
            UserProfileValorationResource userProfileValorationResource = new UserProfileValorationResource(userProfileValorationRepository);
    ...
    public void createUserProfileValorationWithExistingId() throws Exception {
        ...
        UserProfileValoration existingUserProfileValoration = new UserProfileValoration();
        existingUserProfileValoration.setId(1L);

        // An entity with an existing ID cannot be created, so this API call must fail
        restUserProfileValorationMockMvc.perform(post("/api/user-profile-valorations")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(existingUserProfileValoration)))
