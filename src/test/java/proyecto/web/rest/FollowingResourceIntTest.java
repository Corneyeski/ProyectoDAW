...
public class FollowingResourceIntTest {
    ...
    public void setup() {
        MockitoAnnotations.initMocks(this);
            FollowingResource followingResource = new FollowingResource(followingRepository);
    ...
    public void createFollowingWithExistingId() throws Exception {
        ...
        Following existingFollowing = new Following();
        existingFollowing.setId(1L);

        // An entity with an existing ID cannot be created, so this API call must fail
        restFollowingMockMvc.perform(post("/api/followings")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(existingFollowing)))
